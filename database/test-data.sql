...
-- ============================================================================
-- Before running this script, you need to create test users in Supabase Auth:
-- 
...
DO $$
DECLARE
    admin_user_id UUID := '00000000-0000-0000-0000-000000000001'; -- Replace with actual admin UUID
    company_user_id UUID := '00000000-0000-0000-0000-000000000002'; -- Replace with actual company UUID
    candidate_user_id UUID := '00000000-0000-0000-0000-000000000003'; -- Replace with actual candidate UUID
BEGIN
    -- ============================================================================
    ...
    RAISE NOTICE '   Admin: admin@worldcareers.rw / Admin123!';
    RAISE NOTICE '   Company: company@techcorp.rw / Company123!';
    RAISE NOTICE '   Candidate: candidate@example.com / Candidate123!';
    RAISE NOTICE '';
